...
public class FBserviceImpl implements FBService {
	...
	public List<Post> feedOfPage() {
		 ...
		 Connection<Post> pageFeed = fbClient.fetchConnection(tab[2] + "/feed", Post.class,Parameter.with("fields","message,created_time,id,permalink_url,likes"));
	...
	public List<Post> precizeKey(String keyword) {
		ArrayList<Post> listP = new ArrayList<>();
		Connection<Post> pageFeed = fbClient.fetchConnection(tab[1] + "/posts", Post.class,Parameter.with("fields","message,created_time,id,permalink_url,likes"));
